...
docker run -p 8501:8501 -p 9000:9000 -p 9005:80 -d -v $(pwd)/data_files/:/home/data_files/ -v $(pwd)/models/:/home/models/ -v $(pwd)/grimoire/:/home/grimoire/ -v $(pwd)/spells/:/home/spells/ --rm aetheraidocker/grimoire:latest
cd -
